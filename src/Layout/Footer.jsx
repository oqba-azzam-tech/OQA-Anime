...
const Footer = () => {
    ...
    return <footer className="bg-back-layout relative py-[50px] mt-[100px]" >
        ...
        <div onClick={() => { window.scrollTo({ top: 0 });}} className="absolute left-[50%] top-[-10%] w-[50px] h-[50px] rounded-[50%] bg-primary border-2 border-back-layout flex justify-center items-center ">
            <a href="#" className="text-4xl"><IoIosArrowDropup /></a>
        </div>
